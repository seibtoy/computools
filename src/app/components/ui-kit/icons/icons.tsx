...
const LaptopIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={14} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const ComputerIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={12} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={1.5}
    ...
    />
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.5 3.727h5" />
  </svg>
);

const SmartphoneIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={12} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const GamepadIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={20} height={14} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const MonitorIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const SpeakerIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={12} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const WashingMachineIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={1.5}
      d="M11.81 1H2.006a.7.7 0 0 0-.7.7v12.608a.7.7 0 0 0 .7.7h9.806a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7Z"
    />
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M1.305 5.023H12.51" />
...
const HairdryerIcon = ({ color = 'currentColor', ...props }: Props) => (
...
const DrillIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={14} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinejoin="round"
    ...
    />
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12.999 4.195H17" />
  </svg>
);

const DroneIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeWidth={1.4}
...
const FlaskIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const CupIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={12} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={1.5}
...
const TagIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const MagnifyingGlassIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={18} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const MenuAltIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={14} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const MicrophoneIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={18} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const InfoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M8.005 15.01a7.005 7.005 0 1 0 0-14.01 7.005 7.005 0 0 0 0 14.01Z"
    />
  </svg>
);

const FacebookLogoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={10} height={18} fill="none" {...props}>
    <path
      fill="currentColor"
      stroke="currentColor"
      strokeWidth={0.4}
...
const InstagramLogoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={19} height={19} fill="none" {...props}>
    <path
      fill="currentColor"
...
const YoutubeLogoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={14} fill="none" {...props}>
    <path
      fill="currentColor"
...
const TiktokLogoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={13} height={15} fill="none" {...props}>
    <path
      fill="currentColor"
...
const DiscordLogoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={20} height={14} fill="none" {...props}>
    <path
      fill="currentColor"
...
const RedditLogoIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={21} height={18} fill="none" {...props}>
    <path
      fill="currentColor"
...
const XLogoItem = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={18} fill="none" {...props}>
    <path
      fill="currentColor"
...
const HeartIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const RightArrowIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg
...
const ChevronDownIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={9} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ChevronUpIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={9} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const CartIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={18} height={18} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const UserIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={18} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={1.5}
...
const CrossedUserIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={18} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const CrissCrossIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={14} fill="none" {...props}>
    <path stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="m1 1 12 12m0-12L1 13" />
  </svg>
);

const EyeIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={20} height={20} fill="none" {...props}>
    <path
      fill="currentColor"
...
const HideEyeIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={20} height={20} fill="none" {...props}>
...
const LanguagesIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={16} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
const ListIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={17} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={1.5}
    ...
    />
    <path stroke="currentColor" strokeLinecap="round" strokeWidth={1.5} d="M4.508 5.492h5m-5 3.334h5m-5 3.333H7.84" />
  </svg>
);

const FAQIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={16} height={15} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const HeadphonesMicIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={16} fill="none" {...props}>
    <path
      fill="currentColor"
      stroke="currentColor"
...
const LeftArrowIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={14} height={12} fill="none" {...props}>
    <path
      fill="currentColor"
...
const CheckIcon = ({ color = 'currentColor', ...props }: Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{ color }} width={15} height={10} fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
