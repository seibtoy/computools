...
export const LaptopIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const ComputerIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const SmartphoneIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const GamepadIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const MonitorIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const SpeakerIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const WashingMachineIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={strokeWidth}
...
export const DrillIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 14" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinejoin="round"
...
export const DroneIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const FlaskIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const CupIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const TagIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const MagnifyingGlassIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const MenuAltIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const MicrophoneIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const InfoIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const FacebookLogoIcon = ({ strokeWidth = 0.4, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 18" fill="none" {...props}>
    <path
      fill="currentColor"
      stroke="currentColor"
      strokeWidth={strokeWidth}
...
export const TiktokLogoIcon = ({ ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 15" fill="none" {...props}>
    <path
      fill="currentColor"
...
export const XLogoItem = ({ ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="none" {...props}>
    <path
      fill="currentColor"
...
export const HeartIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const RightArrowIcon = ({ ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 12" fill="none" {...props}>
    <path
      fill="currentColor"
...
export const CartIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const UserIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const CrossedUserIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 18" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const CrissCrossIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" fill="none" {...props}>
...
export const LanguagesIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const ListIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 17" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={strokeWidth}
...
export const FAQIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const HeadphonesMicIcon = ({ strokeWidth = 0.7, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 16" fill="none" {...props}>
    <path
      fill="currentColor"
      stroke="currentColor"
...
export const CheckIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 10" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const LogoutIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
...
export const HouseIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeWidth={strokeWidth}
...
export const FunnelIcon = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
