...
const ComputerIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={12} height={16} fill="none" {...props}>
    ...
    />
    <path stroke="#717171" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.5 3.727h5" />
  </svg>
);
...
const SpeakerIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={12} height={16} fill="none" {...props}>
    ...
    />
    <circle cx={6} cy={10} r={2} stroke="#717171" strokeWidth={1.5} />
  </svg>
);
...
const WashingMachineIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={14} height={16} fill="none" {...props}>
    ...
    />
    <path stroke="#717171" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M1.305 5.023H12.51" />
    <path fill="#717171" d="M10.411 3.8a.7.7 0 1 0 0-1.402.7.7 0 0 0 0 1.401Z" />
    <path stroke="#717171" strokeWidth={1.5} d="M6.905 12.56a2.452 2.452 0 1 0 0-4.904 2.452 2.452 0 0 0 0 4.904Z" />
  </svg>
);

const HairdryerIcon = (props: SVGProps<SVGSVGElement>) => (
...
const DrillIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={14} fill="none" {...props}>
    <path
      stroke="#717171"
      strokeLinejoin="round"
    ...
    />
    <path stroke="#717171" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12.999 4.195H17" />
  </svg>
);
...
const MenuAltIcon = (props: SVGProps<SVGSVGElement>) => (
...
const YoutubeLogoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={14} fill="none" {...props}>
    <path
      fill="#717171"
...
const TiktokLogoIcon = (props: SVGProps<SVGSVGElement>) => (
...
const RedditLogoIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={21} height={18} fill="none" {...props}>
    <path
      fill="#717171"
...
const XLogoItem = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} fill="none" {...props}>
    <path
      fill="#717171"
...
const ChevronDownIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={14} height={9} fill="none" {...props}>
    <path
      stroke="#000"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const CrossedUserIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={16} height={18} fill="none" {...props}>
    <path
      stroke="#DC4E4E"
      strokeLinecap="round"
...
const CrissCrossIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} fill="none" {...props}>
    <path stroke="#02BA39" strokeLinecap="round" strokeWidth={1.5} d="m1 1 12 12m0-12L1 13" />
  </svg>
);
...
const HideEyeIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="none" {...props}>
...
const ListIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={14} height={17} fill="none" {...props}>
    ...
    />
    <path stroke="#717171" strokeLinecap="round" strokeWidth={1.5} d="M4.508 5.492h5m-5 3.334h5m-5 3.333H7.84" />
  </svg>
);
...
const HeadphonesMicIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={14} height={16} fill="none" {...props}>
    <path
      fill="#717171"
      stroke="#717171"
