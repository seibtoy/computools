...
import { filters, gamingProducts } from '@/mocks';
import { shuffleArray } from '@/utils';

export default function GamingProductPage() {
  const { filteredProducts, selectedFilters, toggleFilter, clearAllFilters } = useProductFilters(gamingProducts);
  ...
  return (
    <MainLayout
      filtersContent={
        <>
          <FiltersComponent
            filtersData={filters.gamingProducts}
