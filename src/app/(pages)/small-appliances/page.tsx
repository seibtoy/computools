...
import { filters, smallAppliancesProducts } from '@/mocks';
import { shuffleArray } from '@/utils';

export default function SmallAppliancesPage() {
  const { filteredProducts, selectedFilters, toggleFilter, clearAllFilters } =
    useProductFilters(smallAppliancesProducts);
  ...
  return (
    <MainLayout
      filtersContent={
        <>
          <ResponsiveFilters
            filtersData={filters.smallAppliances}
