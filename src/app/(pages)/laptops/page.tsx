...
import { filters, laptopsProducts } from '@/mocks';
import { shuffleArray } from '@/utils';

export default function LaptopPage() {
  const { filteredProducts, selectedFilters, toggleFilter, clearAllFilters } = useProductFilters(laptopsProducts);
